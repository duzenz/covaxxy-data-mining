...
FILE_NAME = "tweet_ids--2021-03-01"
...
def create_csv_for_day():
    ...
    #removed text
    header_long = ['id', 'created_at', 'tweet_id', 'credible', 'author_id', 'len', 'name', 'username', 'verified',
        ...
        for filename in file:
            ...
            if "data" in data:
                for tweet in data["data"]:
                    writer.writerow(get_row(tweet, counter, data["includes"]["users"], data["includes"]["tweets"], lines))
                    counter = counter + 1
    f.close()
