...
def draw_graph():
    ...
    save_figure("First-Day-Of-Months-Retweets-NonCredible", df)
    ...
    save_figure("First-Day-Of-Months-Quotes-NonCredible", df)
    ...
    save_figure("First-Day-Of-Months-Replies-NonCredible", df)
    ...
    save_figure("First-Day-Of-Months-Likes-NonCredible", df)
