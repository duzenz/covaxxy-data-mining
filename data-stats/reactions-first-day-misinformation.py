...
def test(filename):
    ...
    save_figure("reactions-" + filename + "_retweet_misinfo", hourly_count_retweet_count)
    save_figure("reactions-" + filename + "_reply_misinfo", hourly_count_reply_count)
    save_figure("reactions-" + filename + "_quote_misinfo", hourly_count_quote_count)
    save_figure("reactions-" + filename + "_like_misinfo", hourly_count_like_count)
