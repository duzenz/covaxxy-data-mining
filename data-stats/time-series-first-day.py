...
#     dataframe.plot(rot=0, ax=axs, xlabel='Gün içerisindeki saat', ylabel='Atılan tweet sayısı')
...
def save_figure(title, dataframe):
    ...
    plt.title("Ayların İlk Gününde Atılan Tüm Tweetler", fontsize=24, pad=20)
...
def draw_graph():
    ...
    save_figure("2021-01-11", hourly_count_2021_01_11)
    ...
    save_figure("2021-02-01", hourly_count_2021_02_01)
    ...
    save_figure("2021-03-01", hourly_count_2021_03_01)
    ...
    save_figure("2021-04-01", hourly_count_2021_04_01)
    ...
    save_figure("2021-05-01", hourly_count_2021_05_01)
    ...
    save_figure("2021-06-01", hourly_count_2021_06_01)
    ...
    save_figure("2021-07-01", hourly_count_2021_07_01)
    ...
    save_figure("2021-08-01", hourly_count_2021_08_01)
    ...
    save_figure("2021-09-01", hourly_count_2021_09_01)
    ...
    save_figure("2021-10-01", hourly_count_2021_10_01)
    ...
    save_figure("2021-11-01", hourly_count_2021_11_01)
    ...
    save_figure("2021-12-01", hourly_count_2021_12_01)
    ...
    save_figure("First-Day-Of-Months-Credible.png", df)
